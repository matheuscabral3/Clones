Este projeto tem como intuito calcular o IMC de uma pessoa.
...
1 - Altura multiplicada pela altura: ( Altura x Altura ) = Resultado.
2 - Peso dividido pelo quadrado da altura: Peso / (Altura)² ) = Resultado.